...
import { PROJECT_ID, PROJECT_NAME, API_ENDPOINT, SHEET_NAME, SECRET_KEY, CITY_DISPLAY } from '../../../lib/lodha-devanahalli/config'
        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px' }}>
              This upcoming ultra-luxury township in North Bangalore is designed to redefine premium living through expansive landscapes, elegant architecture, and curated lifestyle experiences. The project combines modern infrastructure, wellness-focused amenities, and seamless connectivity to deliver a sophisticated urban lifestyle for discerning homeowners and investors.
            </p>
