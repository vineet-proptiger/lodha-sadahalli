...
import { Dumbbell, HeartPulse, Trophy, Waves, Trees, Building, ShoppingBag, Plane, ShieldCheck } from 'lucide-react'
  ...
  <section id="highlights" style={{
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        ...
        }}>Sadahalli, North Bangalore — Project Excellence</span>
        <h2 style={{
          fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
          color: '#111827', margin: 0, letterSpacing: '-0.01em',
        }}>
          Project Highlights:{' '}
          <span style={{ color: 'var(--color-gold)' }}>Lodha Sadahalli</span>
        </h2>
