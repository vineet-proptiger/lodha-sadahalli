...
import { overviewImage } from '../../../lib/lodha-devanahalli/images'
    ...
    <section id="overview" className="!pt-1 !pb-4 sm:!py-10" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          }}>Sadahalli, North Bangalore — Pre-Launch</span>
          <h2 style={{
            fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
            color: '#111827', margin: 0, letterSpacing: '-0.01em',
          }}>
            Lodha Sadahalli <span style={{ color: 'var(--color-gold)' }}>Overview</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <Image src={overviewImage} alt="Lodha Sadahalli"
          ...
          <div data-aos="fade-up" style={{ display: 'flex' }}>
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ margin: '0 0 16px' }}>{PREVIEW_TEXT}</p>
                <p style={{ margin: 0, fontWeight: 'bold' }}>{MORE_TEXT}</p>
              </div>
