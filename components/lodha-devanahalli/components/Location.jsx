...
const locationItems = [
  '5 Mins from Doddajala Metro Station (Upcoming)',
  '5 Mins from Prestige Tech Cloud',
  '10 Mins from Kempegowda International Airport (KIA)',
  '5 Mins from Upcoming Forum Mall',
  '10 Mins from Sir M. Visvesvaraya Institute Of Technology',
  '12 Mins from Stonehill International School',
  '15 Mins from Cytecare Cancer Hospital',
  '15 Mins from Yelahanka Railway Station',
]
    ...
    <section id="location" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          }}>Sadahalli, North Bangalore</span>
          <h2 style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  Sadahalli, North Bangalore, Bangalore
                </span>
              </div>
            </div>
          </div>
